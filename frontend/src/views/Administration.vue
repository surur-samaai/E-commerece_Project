  ...
  <div id="body">
    ...
    <div class="container">
      ...
      <div class="form-container">
        <form @submit.prevent="saveProduct" class="form">
          ...
          <div class="form-group">
            ...
            <input type="text" id="productCategory" v-model="productForm.categories" required />
          </div>
          <div class="form-group">
          ...
          <button type="submit">{{ productForm.product_id ? 'Update Product' : 'Add Product' }}</button> </form>
      ...
      <div class="product-list">
        <div class="product" v-for="product in $store.state.store" :key="product.product_id"><img :src="product.image_url" alt="Product Image" />
          <h2>{{ product.name }}</h2>
          ...
          <button @click="deleteProduct(product.product_id)">Delete</button> </div>
      </div>
...
export default {
  ...
  methods: {
    ...mapActions(['getProducts', 'deleteProduct', 'addProduct', 'updateProduct']), 
    saveProduct() {
    ...
    addProduct() { 
      console.log("Dispatching addProduct action to Vuex:", this.productForm);
    ...
    updateProduct() { 
      console.log("Dispatching updateProduct action to Vuex:", this.productForm);
      this.$store.dispatch('updateProduct', this.productForm); 
    },
    deleteProduct(productId) {
      console.log("Dispatching deleteProduct action to Vuex for productId:", productId);
  ...
  mounted() {
    console.log("AdminView mounted - fetching products from Vuex");
    this.getProducts(); 
  },
};
</script>
